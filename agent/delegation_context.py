...
KANBAN_ENV_KEYS: tuple[str, ...] = (
    ...
    "HERMES_KANBAN_RUNTIME_FENCE", "HERMES_KANBAN_RUNTIME_GRANTED",
    "HERMES_KANBAN_BOOTSTRAP_PATH", "HERMES_KANBAN_PREPARATION_ID",
    "HERMES_KANBAN_EXPECTED_RUNTIME", "HERMES_KANBAN_BOOTSTRAP_WAIT",
)
